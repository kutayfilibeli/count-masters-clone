...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        gm = GameObjectManager.instance.allObjects[2].GetComponent<GameManager>();
    }
    ...
    public void Move()
    {
        ...
        if (Physics.Raycast(ray,out RaycastHit hit, 50))
        {
            ...
            transform.position = Vector3.MoveTowards(transform.position, hitPoint, Time.deltaTime * sideSpeed);
        }
    }
